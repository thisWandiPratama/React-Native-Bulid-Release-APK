            ...
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={{ width: '80%', alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={styles.destitle1}>Masukan alamat email yang terhubung dengan akun anda</Text>
                    </View>
                    ...
                    <TouchableOpacity style={styles.btnLanjutkan} onPress={() => this.setState({ modal: !this.state.modal })}>
