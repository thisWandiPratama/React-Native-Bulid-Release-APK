...
class DetailSuratMasuk extends React.Component {
    ...
    renderContent = () => {
        if (this.state.tabDetailDraft === true) {
            return (
                <View style={{
                    margin: 10,
                    marginTop: 15
                    ...
                    <TouchableOpacity
                        ...
                        style={{
                            height: 25,
                            width: 130,
                            backgroundColor: this.state.parafrase===true ? '#717A83' : '#F3BA46',
            ...
            return (
                <View style={{
                    ...
                    >Penandatanganan</Text>
                    <Text
                    style={{
                        color:'#000'
                    }}
                    >SEKRETARIAT KEMENTERIAN</Text>
                    <Text
                        style={{
                            paddingBottom: 10,
                            borderBottomWidth: 1,
                    ...
                    >DEPUTI BIDANG PERLINDUNGAN KHUSUS ANAK</Text>
                    <Text
                        style={{
                            paddingBottom: 10,
                            borderBottomWidth: 1,
        ...
        else if (this.state.tabFileSurat === true) {
            return (
                <View
                    style={{
                        margin: 20,
                    ...
                    >
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                justifyContent: 'center',
                                borderBottomWidth: 2,
                                borderBottomColor: this.state.tabDetailDraft === true ? '#F3BA46' : 'transparent'
                            }}
                        >
                            <Text
                                style={{
                                    fontSize: 14,
                                    color: this.state.tabDetailDraft === true ? '#F3BA46' : '#717883'
                                }}
                            >
                                Detail Draft
                            </Text>
                        ...
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                justifyContent: 'center',
                                borderBottomWidth: 2,
                                borderBottomColor: this.state.tabTujuanSurat === true ? '#F3BA46' : 'transparent'
                            }}
                        >
                            <Text
                                style={{
                                    fontSize: 14,
                                    color: this.state.tabTujuanSurat === true ? '#F3BA46' : '#717883'
                                }}
                            >
                                Tujuan Surat
                            </Text>
                        ...
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                justifyContent: 'center',
                                borderBottomWidth: 2,
                                borderBottomColor: this.state.tabFileSurat === true ? '#F3BA46' : 'transparent'
                            }}
                        >
                            <Text
                                style={{
                                    fontSize: 14,
                                    color: this.state.tabFileSurat === true ? '#F3BA46' : '#717883'
                                }}
                            >
                                File Surat
                            </Text>
                        ...
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                justifyContent: 'center',
                                borderBottomWidth: 2,
                                borderBottomColor: this.state.tabSiklus === true ? '#F3BA46' : 'transparent'
                            }}
                        >
                            <Text
                                style={{
                                    fontSize: 14,
                                    color: this.state.tabSiklus === true ? '#F3BA46' : '#717883'
                                }}
                            >
                                Siklus
                            </Text>
