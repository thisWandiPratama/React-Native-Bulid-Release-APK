          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text
                style={{
                  fontSize: 14,
                  color:
                    this.state.count === 0 ? '#EB5F3C' : '#717883',
                }}>
                Detail Surat
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text
                style={{
                  fontSize: 14,
                  color:
                    this.state.count === 1 ? '#EB5F3C' : '#717883',
                }}>
                Tujuan Surat
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              style={{
                ...
                borderBottomWidth: 2,
                borderBottomColor:
                  this.state.count === 2 ? '#EB5F3C' : 'transparent',
              }}>
              <Text
                style={{
                  fontSize: 14,
                  color:
                    this.state.count === 2 ? '#EB5F3C' : '#717883',
                }}>
                File Surat
              </Text>
            </TouchableOpacity>
