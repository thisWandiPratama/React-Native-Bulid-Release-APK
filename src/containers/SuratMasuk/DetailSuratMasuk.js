          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text
                style={{
                  fontSize: 14,
                  color: this.state.count === 0 ? '#C43832' : '#717883',
                }}>
                Detail Surat
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text
                style={{
                  fontSize: 14,
                  color: this.state.count === 1 ? '#C43832' : '#717883',
                }}>
                Lihat Surat
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              style={{
                ...
                borderBottomWidth: 2,
                borderBottomColor:
                  this.state.count === 2 ? '#C43832' : 'transparent',
              }}>
              <Text
                style={{
                  fontSize: 14,
                  color: this.state.count === 2 ? '#C43832' : '#717883',
                }}>
                Siklus
              </Text>
            </TouchableOpacity>
